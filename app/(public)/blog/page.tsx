...
export const metadata: Metadata = {
  title: buildMetaTitle("Blog"),
  description: "Articles, news, and inspiration from the world of wellbeing",
}
      ...
      <div className="pt-28 lg:pt-32 pb-12 bg-muted/30 border-b">
        <div className="mx-auto w-full max-w-5xl px-4">
          ...
          <p className="text-muted-foreground mt-2">
            Articles, news, and inspiration from the world of wellbeing
          </p>
        </div>
      </div>
      <AfterHeroRegion />
