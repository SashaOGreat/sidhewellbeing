  ...
  return (
    <aside className="w-full shrink-0 border-b bg-card lg:w-64 lg:border-b-0 lg:border-r flex flex-col max-h-[50vh] lg:max-h-none lg:min-h-[calc(100vh-3rem)]">
      <div className="px-3 py-2.5 border-b">
        <h2 className="text-sm font-normal text-foreground">Categories</h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-3">
        {loading ? (
          ...
          <p className="text-sm text-muted-foreground px-1 py-2">
            No categories yet. Add the first one with the button below.
          </p>
        ) : (
          <DndContext
            sensors={sensors}
        ...
        >
          ...
          <span className="font-normal text-sm">New category</span>
        </button>
      </div>
    </aside>
  )
