-- ============================================
-- SIDHE Wellbeing - Supabase SQL Schema
...
-- Content blocks: root = grid; cell contents = heading | text_block
...
insert into site_settings (key, value) values
  ('homepage_h1', 'SIDHE Wellbeing'),
  ('homepage_description', 'Wellbeing, balance, and care for a better quality of life.'),
...
-- ============================================
-- MIGRATION: text_blocks → content_blocks (existing DB with the old schema)
-- Run supabase-migrate-text-blocks-to-content-blocks.sql
-- ============================================
