...
export type Category = {
  ...
  /** Inline SVG from the DB (optional icon). */
...
/** Root grid layout (cell count = cellCount). */
export type GridLayoutId = "1" | "2" | "3" | "4" | "2x2" | "3x3"

/** Sub-block in a grid cell. */
...
/** Root of the page = `grid`; cell contents = `heading` | `text_block`. */
...
export type ContentBlock = {
  ...
  /** Cell index within the parent grid (0 … cellCount-1). */
  cell_index: number
